      ...
      <form onSubmit={handleSearch} className="mb-12">
        <div className="flex gap-2">
          ...
          <button 
            ...
            type="submit"
            className="bg-amber-500 hover:bg-amber-600 disabled:bg-zinc-800 disabled:text-zinc-600 text-black font-black px-8 py-4 rounded-2xl transition-all shadow-lg shadow-amber-500/10 uppercase tracking-widest text-sm"
          >
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 leading-relaxed text-zinc-300 whitespace-pre-wrap">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-black uppercase text-zinc-500 tracking-widest">Market Status: {location}</span>
            </div>
            {results.text}
          </div>
        </div>
