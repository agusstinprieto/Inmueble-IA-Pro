        ...
        <div className="p-4 lg:p-8 space-y-8 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    >
                        <Video size={24} style={{ color: brandColor }} />
                    </div>
                    <div>
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity p-8">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button
                                                onClick={handleShare}
                                                className={`p-2 backdrop-blur-md rounded-lg text-white transition-all ${isCopied ? 'bg-green-600' : 'bg-black/60 hover:bg-white/10'
                                                    }`}
                                            >
