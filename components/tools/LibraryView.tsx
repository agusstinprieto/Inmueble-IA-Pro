                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-white italic uppercase tracking-tighter mb-2">
                            {lang === 'es' ? 'BIBLIOTECA' : 'DIGITAL'} <span style={{ color: brandColor }}>{lang === 'es' ? 'DIGITAL' : 'LIBRARY'}</span>
                        </h1>
                        <p className="text-zinc-500 font-bold italic uppercase tracking-widest">
                            {lang === 'es' ? 'GESTIONA Y ORGANIZA TUS RECURSOS DIGITALES' : 'MANAGE AND ORGANIZE YOUR DIGITAL RESOURCES'}
                        </p>
                    </div>
                </div>
                {agencyId && (
